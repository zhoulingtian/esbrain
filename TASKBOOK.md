...
| 八 学习路径与辅助 | 已完成 | 2026-08-03 | 首次向导采集目标级别、每日时长和偏好，首页按真实到期复习量生成可跳过建议；错题本分词汇、语法专项、听力，周报基于真实复习/错题日志生成准确率和行动建议；设置页新增私密 Gist 同步，token 仅留本地状态，分叉时展示双方统计并要求选择。assemble 全绿，smoke 87 passed / 0 failed；sw.js v12。 |
